...
/**
 * 自定义时钟View
 * http://www.jianshu.com/users/a45d19d680af/
...
public class ClockView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            desiredWidth = mRadius * 2 + paddingHorizontal;
        ...
        if (heightMode == MeasureSpec.EXACTLY) {
            ...
            desiredHeight = mRadius * 2 + paddingVertical;
        ...
        mCanvasHeight = desiredHeight + 4;
        setMeasuredDimension(mCanvasWidth, mCanvasHeight);

        mRadius = (int) (Math.min(desiredWidth - paddingHorizontal,
                desiredHeight - paddingVertical) * 1.0f / 2);
        calculateLengths();
    }
