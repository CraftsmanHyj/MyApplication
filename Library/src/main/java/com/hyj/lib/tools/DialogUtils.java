...
public class DialogUtils {
     ...
     * @param e
     */
    public static Dialog showExceptionDialog(Context context, String title, Throwable e, DialogAction okAction) {
     ...
     * @param e
     */
    public static Dialog showExceptionDialog(Context context, String title, Throwable e) {
     ...
     * @param okAction
     */
    public static Dialog showExceptionDialog(Context context, Throwable e, DialogAction okAction) {
     ...
     * @return
     */
    public static Dialog showConfirmDialog(Context context, String title, String msg, final DialogAction okAction) {
     ...
     * @param view
     */
    public static Dialog showDialog(Context context, String title, View view, DialogAction okAction) {
