...
public class FileInfo implements Serializable {
    ...
    public void setUrl(String url, boolean setFileName) {
        ...
        if (setFileName) {
            setFileName(url.substring(url.lastIndexOf(File.separator) + 1));
        }
    }
    ...
    public boolean isDowning() {
        return DownService.ACTION_START.equals(downStatus);
    }
