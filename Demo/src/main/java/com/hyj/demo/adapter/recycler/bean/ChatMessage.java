package com.hyj.demo.adapter.recycler.bean;
...
public class ChatMessage {
    ...
    static {
        ...
        msg = new ChatMessage(R.drawable.img_head, "xiaohei", "where are you ",
                null, false);
        MOCK_DATAS.add(msg);
        msg = new ChatMessage(R.drawable.me, "renma", "where are you ",
                null, true);
        MOCK_DATAS.add(msg);
        msg = new ChatMessage(R.drawable.img_head, "xiaohei", "where are you ",
                null, false);
