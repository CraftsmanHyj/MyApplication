...
public class AudioRecorderButton extends Button {
     ...
     */
    public void setOnAudioRecorderFinishListener(OnAudioRecorderFinishListener mFinishListener) {
     ...
     */
    public void setOnAudioRecorderLongClickLisetener(OnAudioRecorderLongClickLisetener mLongClickListener) {
    ...
    private void initView(Context context) {
        ...
        audioDir = FileUtils.getAppDir(context, Constants.DIR_RECORDER).getAbsolutePath();
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (!isRecording || mTime < 0.6f) {
                    ...
                    if (null != mFinishListener) {
                        mFinishListener.onFinish(mTime, mAudioManager.getCurrentFilePath());
                    }
