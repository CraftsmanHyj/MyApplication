package com.hyj.demo.wechat_talk;
...
import com.hyj.demo.wechat_talk.AudioRecorderButton.OnAudioRecorderFinishListener;
import com.hyj.demo.wechat_talk.AudioRecorderButton.OnAudioRecorderLongClickLisetener;
...
public class WeChatTalkActivity extends BaseActivity {
            ...
            public void run() {
                ...
                if (null != audioFiles && audioFiles.length > 0) {
                    ...
                    for (String fileName : audioFiles) {
                        int duration = getAmrDuration(dirPath + File.separator + fileName);
                        recorder = new Recorder(duration, dirPath + File.separator + fileName);
                        lDatas.add(recorder);
                    }
                }
    ...
    private void initListener() {
        btRecorder.setOnAudioRecorderFinishListener(new OnAudioRecorderFinishListener() {
        ...
        btRecorder.setOnAudioRecorderLongClickLisetener(new OnAudioRecorderLongClickLisetener() {
            @Override
