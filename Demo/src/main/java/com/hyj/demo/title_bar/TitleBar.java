...
public class TitleBar extends RelativeLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        leftTextColor = ta.getColor(R.styleable.title_leftTextColor, defaultColor);
        leftBackground = ta.getDrawable(R.styleable.title_leftBackground);
        leftText = ta.getString(R.styleable.title_leftText);

        rightTextColor = ta.getColor(R.styleable.title_rightTextColor, defaultColor);
        ...
        titleTextColor = ta.getColor(R.styleable.title_titleColor, defaultColor);
