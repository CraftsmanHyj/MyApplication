...
public class DirPopupWindow extends PopupWindow {
    ...
    private void initViews(Context context) {
        View mConvertView = LayoutInflater.from(context).inflate(R.layout.wechat_imageup_pop, null);
        ...
        mListView.setAdapter(new DirAdapter(context, mDatas, R.layout.wechat_imageup_pop_item));
    }
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (null != mLisetner) {
                    ...
                    FolderBean bean = (FolderBean) parent.getItemAtPosition(position);
                    bean.setSel(true);
                    preSelFolder = bean;
    ...
    private class DirAdapter extends CommonAdapter<FolderBean> {
        ...
        @Override
        public void getItemView(ViewHolder holder, FolderBean item) {
