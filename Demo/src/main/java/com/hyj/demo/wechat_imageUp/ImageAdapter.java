...
public class ImageAdapter extends CommonAdapter<String> {
     ...
     * @param mSelListener
     */
    public void setOnPictureSelectedListener(PictureSelectedListener mSelListener) {
    ...
    @Override
    public void getItemView(ViewHolder holder, final String path) {
